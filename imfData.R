...
#One CSV for RSA, UGA, ETH, TZA, DZA, AGO, BFA, BDI, TCD, SWZ, GAB, LBR, MOZ, NAM, NER, NGA, SEN, SLE, SDN, GMB, TGO, TUN, ZMB, ZWE 
...
africaData <- countryList %>%
                   ...
                   # select(-c("Common.Reference.Period", "Country.Name", "IMF.Code", "Attribute")) %>%
                    ...
                    filter(!Geography %in% c("ZAF", "UGA", "ETH", "TZA", "KEN", "DZA", "AGO", "BFA", "BDI", "TCD", "SWZ", "GAB", "LBR", "MOZ", "MWI", "NAM", "NER", "NGA", "SEN", "SLE", "SDN", "GMB", "TGO", "TUN", "ZMB", "ZWE")) %>%
